...
export const LarkMemberInviteStrings: LocaleDict = {
  en: {
    ...
    "LarkInvite.organization.limited": "Department names are awaiting admin approval. Showing everyone currently visible to the app so you can invite people now.",
  ...
  zh: {
    ...
    "LarkInvite.organization.limited": "部门名称权限正在等待管理员审核；先展示应用当前可见的全部成员，可直接选择邀请。",
