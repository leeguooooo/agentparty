...
const TASK_KEYS = [
  ...
  "Channel.tasks.total",
  "Channel.tasks.journalTitle",
  "Channel.tasks.cmdCount",
  "Channel.tasks.grepState",
  "Channel.tasks.filter.needs",
  "Channel.tasks.filter.all",
  "Channel.tasks.stateFilterAria",
  "Channel.tasks.searchPlaceholder",
  "Channel.tasks.searchAria",
  "Channel.tasks.priorityAria",
  "Channel.tasks.rowToggleAria",
  "Channel.tasks.moveAria",
